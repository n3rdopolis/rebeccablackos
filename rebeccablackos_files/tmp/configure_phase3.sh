...
then
  ...
  dpkg-divert --local --rename --add /usr/share/plymouth/themes/text/text.plymouth
  ln -s /usr/share/plymouth/themes/rebeccablackos-text/rebeccablackos-text.plymouth /usr/share/plymouth/themes/text/text.plymouth
fi
