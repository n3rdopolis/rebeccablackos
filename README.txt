...
PROBLEMS:
      ...
      Enlightenment requires wlminputinsecure to be passed to the kernel command line. This causes the waylandloginmanager to allow full access to all input devices. wlminputinsecure is passed by default on the Live CD, but isn't passed if you choose to use a framebuffer. wlminputinsecure is NOT passed by default if you install the system as well.
