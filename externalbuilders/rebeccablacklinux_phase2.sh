...
mount -t overlayfs -o lowerdir=$RBOSLOCATION/build/$BUILDARCH/phase_1,upperdir=$RBOSLOCATION/build/$BUILDARCH/phase_2 overlayfs $RBOSLOCATION/build/$BUILDARCH/workdir
