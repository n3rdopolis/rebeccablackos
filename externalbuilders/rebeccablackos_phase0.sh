...
then
  ...
  "$BUILDLOCATION"/debootstrap/debootstrap --arch $BUILDARCH vivid "$BUILDLOCATION"/build/$BUILDARCH/phase_1 http://ubuntu.osuosl.org/ubuntu/
...
then
  ...
  "$BUILDLOCATION"/debootstrap/debootstrap --arch $BUILDARCH vivid "$BUILDLOCATION"/build/$BUILDARCH/phase_2 http://ubuntu.osuosl.org/ubuntu/
