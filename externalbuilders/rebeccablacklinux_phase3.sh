...
mv $RBOSLOCATION/build/$BUILDARCH/phase_3/home/remastersys/remastersys/custom-full.iso $HOMELOCATION/RebeccaBlackLinux_Development_$BUILDARCH.iso
...
cp -a "$RBOSLOCATION/build/$BUILDARCH/workdir/usr/share/logs/"* "$RBOSLOCATION/logs/$ENDDATE"
